...
**필수 규칙:**
  ...
  - **항상** 전체 대화 기록을 고려하세요.`,
    ...
    setting: {
      ...
      awsAuthModeBedrockAPIKey: 'Bedrock API 키',
      bedrockAPIKey: 'Bedrock API 키',
      bedrockAPIKeyMessage: 'Bedrock API 키를 입력하세요',
      bedrockEndpointType: '엔드포인트 유형',
      bedrockEndpointRuntime: 'Bedrock Runtime',
      bedrockEndpointMantleOpenAI: 'Mantle(OpenAI 호환)',
      bedrockEndpointMantleAnthropic: 'Mantle(Anthropic 호환)',
      bedrockEndpointURL: '엔드포인트 URL',
      bedrockEndpointURLMessage:
        '신뢰할 수 있는 Bedrock HTTPS 엔드포인트를 입력하세요',
      bedrockDiscoveryEndpointURL: '모델 검색 엔드포인트 URL',
      bedrockDiscoveryEndpointURLMessage:
        '모델 목록 조회를 위한 선택적 Bedrock 컨트롤 플레인 엔드포인트',
