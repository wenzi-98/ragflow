export default {
  translation: {
    ...
    skills: {
      ...
      skillExists: '同名 Skills 已已存在，请先删除或使用其他名称',
...
例如：一条带有 1024 维 Embedding 的 1 KB 消息大约使用 9 KB。5 MB 的默认限制大约可容纳 500 条此类消息。`,
    ...
    knowledgeDetails: {
      ...
      noStructureSessionEssence: '暂无 Session Essence',
      noStructureSessionGraph: '暂无 Session Graph',
      ...
      directoryName: '名称',
      directoryNamePlaceholder: 'Entity 名称',
      directoryRule: '规则',
...
示例：general/v2/`,
      ...
      blueprints: '蓝图',
      blueprintsDescription: '选择所需要的蓝图',
      custom: '自定义',
      templates: '模板',
      ...
      awsAuthModeBedrockAPIKey: 'Bedrock API 密钥',
      bedrockAPIKey: 'Bedrock API 密钥',
      bedrockAPIKeyMessage: '请输入 Bedrock API 密钥',
      bedrockEndpointType: '端点类型',
      bedrockEndpointRuntime: 'Bedrock Runtime',
      bedrockEndpointMantleOpenAI: 'Mantle（兼容 OpenAI）',
      bedrockEndpointMantleAnthropic: 'Mantle（兼容 Anthropic）',
      bedrockEndpointURL: '端点 URL',
      bedrockEndpointURLMessage: '请输入可信的 Bedrock HTTPS 端点',
      bedrockDiscoveryEndpointURL: '模型发现端点 URL',
      bedrockDiscoveryEndpointURLMessage:
        '可选，用于列出模型的 Bedrock 控制面端点',
    ...
    datasetSkill: {
      ...
      selectFolder: '选择一个 Skill 以查看详情',
      currentFolder: 'Skills',
      noContent: '无内容',
      deleteAllTitle: '删除全部 Skills',
      deleteAllDescription: '确定要删除全部 Skills 吗？此操作无法撤销。',
      deleteSkillTitle: '删除 Skill',
      deleteSkillDescription: '确定要删除该 Skill 吗？',
    },
    datasetNav: {
      title: 'PageIndex',
      empty: '暂无导航节点',
      ...
      keywords: 'Keyword',
      entities: 'Entity',
      graphContent: '完整 Graph 内容',
      docCount: '{{count}} 个文档',
      deleteAllTitle: '删除 PageIndex',
      deleteAllDescription: '确定要删除整个 PageIndex 吗吗？此操作无法撤销。',
      deleteNodeTitle: '删除 PageIndex',
