...
**Основные правила:**
  ...
  - **Всегда учитывайте** всю историю диалога.`,
    ...
    setting: {
      ...
      awsAuthModeBedrockAPIKey: 'Ключ API Bedrock',
      bedrockAPIKey: 'Ключ API Bedrock',
      bedrockAPIKeyMessage: 'Введите ключ API Bedrock',
      bedrockEndpointType: 'Тип конечной точки',
      bedrockEndpointRuntime: 'Bedrock Runtime',
      bedrockEndpointMantleOpenAI: 'Mantle (совместимый с OpenAI)',
      bedrockEndpointMantleAnthropic: 'Mantle (совместимый с Anthropic)',
      bedrockEndpointURL: 'URL конечной точки',
      bedrockEndpointURLMessage:
        'Введите доверенную конечную точку Bedrock HTTPS',
      bedrockDiscoveryEndpointURL: 'URL конечной точки обнаружения моделей',
      bedrockDiscoveryEndpointURLMessage:
        'Необязательная конечная точка плоскости управления Bedrock для получения списка моделей',
