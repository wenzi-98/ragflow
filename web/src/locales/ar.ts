export default {
  translation: {
    ...
    setting: {
      ...
      awsAuthModeBedrockAPIKey: 'مفتاح Bedrock API',
      bedrockAPIKey: 'مفتاح Bedrock API',
      bedrockAPIKeyMessage: 'أدخل مفتاح Bedrock API',
      bedrockEndpointType: 'نوع نقطة النهاية',
      bedrockEndpointRuntime: 'Bedrock Runtime',
      bedrockEndpointMantleOpenAI: 'Mantle (متوافق مع OpenAI)',
      bedrockEndpointMantleAnthropic: 'Mantle (متوافق مع Anthropic)',
      bedrockEndpointURL: 'عنوان URL لنقطة النهاية',
      bedrockEndpointURLMessage: 'أدخل نقطة نهاية Bedrock موثوقة تستخدم HTTPS',
      bedrockDiscoveryEndpointURL: 'عنوان URL لنقطة نهاية اكتشاف النماذج',
      bedrockDiscoveryEndpointURLMessage:
        'نقطة نهاية اختيارية لمستوى تحكم Bedrock لسرد النماذج',
