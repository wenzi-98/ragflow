...
**Temel Kurallar:**
  ...
  - **Her zaman** konuşma geçmişinin tamamını göz önünde bulundurun.`,
    ...
    setting: {
      ...
      awsAuthModeBedrockAPIKey: 'Bedrock API anahtarı',
      bedrockAPIKey: 'Bedrock API anahtarı',
      bedrockAPIKeyMessage: 'Bedrock API anahtarınızı girin',
      bedrockEndpointType: 'Uç nokta türü',
      bedrockEndpointRuntime: 'Bedrock Runtime',
      bedrockEndpointMantleOpenAI: 'Mantle (OpenAI uyumlu)',
      bedrockEndpointMantleAnthropic: 'Mantle (Anthropic uyumlu)',
      bedrockEndpointURL: "Uç nokta URL'si",
      bedrockEndpointURLMessage: 'Güvenilir bir Bedrock HTTPS uç noktası girin',
      bedrockDiscoveryEndpointURL: "Model keşfi uç noktası URL'si",
      bedrockDiscoveryEndpointURLMessage:
        'Modelleri listelemek için isteğe bağlı Bedrock kontrol düzlemi uç noktası',
