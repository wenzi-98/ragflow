...
<p>Siehe https://ragflow.io/docs/dev/use_tag_sets für Details.</p>
    ...
    setting: {
      ...
      awsAuthModeBedrockAPIKey: 'Bedrock-API-Schlüssel',
      bedrockAPIKey: 'Bedrock-API-Schlüssel',
      bedrockAPIKeyMessage: 'Geben Sie Ihren Bedrock-API-Schlüssel ein',
      bedrockEndpointType: 'Endpunkttyp',
      bedrockEndpointRuntime: 'Bedrock Runtime',
      bedrockEndpointMantleOpenAI: 'Mantle (OpenAI-kompatibel)',
      bedrockEndpointMantleAnthropic: 'Mantle (Anthropic-kompatibel)',
      bedrockEndpointURL: 'Endpunkt-URL',
      bedrockEndpointURLMessage:
        'Geben Sie einen vertrauenswürdigen Bedrock-HTTPS-Endpunkt ein',
      bedrockDiscoveryEndpointURL: 'URL des Endpunkts für die Modellerkennung',
      bedrockDiscoveryEndpointURLMessage:
        'Optionaler Bedrock-Endpunkt der Steuerungsebene zum Auflisten von Modellen',
