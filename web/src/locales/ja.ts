...
上記が要約する内容です。`,
    ...
    setting: {
      ...
      awsAuthModeBedrockAPIKey: 'Bedrock APIキー',
      bedrockAPIKey: 'Bedrock APIキー',
      bedrockAPIKeyMessage: 'Bedrock APIキーを入力してください',
      bedrockEndpointType: 'エンドポイントタイプ',
      bedrockEndpointRuntime: 'Bedrock Runtime',
      bedrockEndpointMantleOpenAI: 'Mantle（OpenAI互換）',
      bedrockEndpointMantleAnthropic: 'Mantle（Anthropic互換）',
      bedrockEndpointURL: 'エンドポイントURL',
      bedrockEndpointURLMessage:
        '信頼できるBedrock HTTPSエンドポイントを入力してください',
      bedrockDiscoveryEndpointURL: 'モデル一覧取得エンドポイントURL',
      bedrockDiscoveryEndpointURLMessage:
        'モデル一覧取得用のBedrockコントロールプレーンエンドポイント（任意）',
