...
**Essential Rules:**
  ...
  - **Always consider** the entire conversation history.`,
    ...
    setting: {
      ...
      awsAuthModeBedrockAPIKey: 'Bedrock API key',
      bedrockAPIKey: 'Bedrock API key',
      bedrockAPIKeyMessage: 'Please enter your Bedrock API key',
      bedrockEndpointType: 'Endpoint type',
      bedrockEndpointRuntime: 'Bedrock Runtime',
      bedrockEndpointMantleOpenAI: 'Mantle (OpenAI-compatible)',
      bedrockEndpointMantleAnthropic: 'Mantle (Anthropic-compatible)',
      bedrockEndpointURL: 'Endpoint URL',
      bedrockEndpointURLMessage: 'Enter a trusted Bedrock HTTPS endpoint',
      bedrockDiscoveryEndpointURL: 'Model discovery endpoint URL',
      bedrockDiscoveryEndpointURLMessage:
        'Optional Bedrock control-plane endpoint for listing models',
